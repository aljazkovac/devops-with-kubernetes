# Project Context: DevOps with Kubernetes Exercises

## Project Overview

This repository contains the exercises for the [DevOps with Kubernetes](https://courses.mooc.fi/org/uh-cs/courses/devops-with-kubernetes) course from the University of Helsinki. It's a monorepo containing several small Node.js applications designed to be containerized with Docker and deployed to Kubernetes.
